...
> NOTE: MusicTunes is going through a major rewrite, so errors, bugs, and other problems may happen at random.
...
MusicTunes is a fully-featured music listening experience, while helping to ease your privacy concerns associated with other platforms.

Some of MusicTunes's features includes:
...
| ----------------------------- | ----------------------------------------------------- |
| `app`                         | MusicTunes web app                                      |
| `packages/hls-proxy-rewriter` | Proxy server used for MusicTunes's music playback (WIP) |
...
| Name                         | URL
| ---                          | ---                                                                       |
| MusicTunes (Official) | https://MusicTunes.ml                                                       |
...
| Project Segfault (Tor)       | http://MusicTunes.pjsfkvpxlinjamtawaksbnnaqs2fc2mtvmozrzckxh7f3kis6yea25ad.onion/ |
...
Want to support MusicTunes financially to aid with future development/hosting?
...
[DockerHub](https://hub.docker.com/r/snuffydev/MusicTunes)

### docker-compose (production)
The quickest way to host a MusicTunes instance is with [Docker](https://www.docker.com/get-started). Once you have it installed, you can run:
...
You can find (temporary, incomplete, and in-progress) API documentation here: https://MusicTunes-docs.vercel.app/

> It's recommended (and appreciated) to host your own instance of MusicTunes for public projects that want to use the data -- especially if you anticipate you will be making a large amount of requests. Thanks!
