	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/v1/get_queue.json/_server.ts.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/v1/get_search_suggestions.json/_server.ts.js')
			},
			{
				id: "/api/v1/main.json",
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/v1/main.json/_server.ts.js')
			},
			{
				id: "/api/v1/next.json",
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/v1/next.json/_server.ts.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/v1/player.json/_server.ts.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/v1/playlist.json/_server.ts.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/v1/related.json/_server.ts.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/v1/search.json/_server.ts.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/v1/stats.json/_server.ts.js')
			},
			{
				id: "/artist/[slug]",
				pattern: /^\/artist\/([^/]+?)\/?$/,
			...
			},
			{
				...
				params: [{"name":"slug","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: () => import('./entries/endpoints/artist/_slug_/releases.json/_server.ts.js')
			},
			{
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/explore.json/_server.ts.js')
			},
			{
				id: "/explore",
				pattern: /^\/explore\/?$/,
			...
			},
			{
				...
				params: [{"name":"slug","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: () => import('./entries/endpoints/explore/_slug_.json/_server.ts.js')
			},
			{
				id: "/explore/[slug]",
				pattern: /^\/explore\/([^/]+?)\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/home.json/_server.ts.js')
			},
			{
				id: "/home",
				pattern: /^\/home\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/trending.json/_server.ts.js')
			},
			{
				id: "/trending",
				pattern: /^\/trending\/?$/,
			...
			},
			{
				...
				params: [{"name":"slug","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: () => import('./entries/endpoints/trending/new/_slug_.json/_server.ts.js')
			},
			{
